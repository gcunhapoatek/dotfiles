...
CACHE="/tmp/sketchybar_weather.cache"
...
case "$COND" in
  *Sunny*|*Clear*)                                    ICON="󰖙"; COLOR=$YELLOW ;;
  *Partly\ cloudy*|*Partly*)                          ICON="󰖕"; COLOR=$SUBTEXT0 ;;
  *Cloudy*|*Overcast*)                                ICON="󰖐"; COLOR=$OVERLAY2 ;;
  *Mist*|*Fog*|*Haze*)                                ICON="󰖑"; COLOR=$OVERLAY1 ;;
  *Thunder*)                                          ICON="󰖓"; COLOR=$MAUVE ;;
  *Snow*|*Blizzard*|*Sleet*)                          ICON="󰼶"; COLOR=$SKY ;;
  *Rain*|*Drizzle*|*Shower*)                          ICON="󰖖"; COLOR=$BLUE ;;
  *)                                                  ICON="󰖙"; COLOR=$YELLOW ;;
esac
